...
ggsave(file = "pain_con_avg.png", plot = p_con_pain, dpi = 100, width = 16, height = 22)
ggsave(file = "unp_con_avg.png", plot = p_con_unp, dpi = 100, width = 16, height = 22)
ggsave(file = "Q1_con_avg.png", plot = p_con_Q1, dpi = 100, width = 16, height = 22)
...
ggsave(file = "pain_diff.png", plot = p_test, dpi = 100, width = 16, height = 22)
ggsave(file = "unp_diff.png", plot = p_test_unp, dpi = 100, width = 16, height = 22)
ggsave(file = "Q1_diff.png", plot = p_test_Q1, dpi = 100, width = 16, height = 22)
