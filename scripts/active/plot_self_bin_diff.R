...
##不快感
p_1<-ggplot(data=data_sum,aes(x=bin,y=unp_avg))
...
##Q1
p_1<-ggplot(data=data_sum,aes(x=bin,y=Q1_avg))
...
##Q2
p_1<-ggplot(data=data_sum,aes(x=bin,y=Q2_avg))
...
##Q3
p_1<-ggplot(data=data_sum,aes(x=bin,y=Q3_avg))
...
#file_name=paste(file_pass,data_self$ID[1],"plot_bin_diff.png",sep="")

#ggsave(file = file_name, plot = p_bin_diff, dpi = 100, width = 12,height =58.6,limitsize = FALSE)


file_name=paste(file_pass,data_self$ID[1],"plot_bin_diff_pain.png",sep="")
ggsave(file = file_name, plot = p_pain, dpi = 100, width = 8.27,height = 11.69)

file_name=paste(file_pass,data_self$ID[1],"plot_bin_diff_unp.png",sep="")
ggsave(file = file_name, plot = p_unp, dpi = 100, width = 8.27,height = 11.69)

file_name=paste(file_pass,data_self$ID[1],"plot_bin_diff_Q1.png",sep="")
ggsave(file = file_name, plot = p_Q1, dpi = 100, width = 8.27,height = 11.69)

file_name=paste(file_pass,data_self$ID[1],"plot_bin_diff_Q2.png",sep="")
ggsave(file = file_name, plot = p_Q2, dpi = 100, width = 8.27,height = 11.69)

file_name=paste(file_pass,data_self$ID[1],"plot_bin_diff_Q3.png",sep="")
