...
data_pre<-data_adapt%>%
  ...
  mutate(trial_condition=factor(
    if_else(
      condition=="arm_delay=500,stimu_delay=0",true = "catch",false = "base"
    )
  ))%>%
...
p_3<-p_2+
  ...
  geom_jitter(data = data_pre,aes(x=condition,y=rating_pain,group=condition,shape=simul),size=2,width = 0.1)+
...
p_3<-p_2+
  ...
  geom_jitter(data = data_pre,aes(x=condition,y=rating_unp,group=condition,shape=simul),size=2,width = 0.1)+
...
p_3<-p_2+
  ...
  geom_jitter(data = data_pre,aes(x=condition,y=Q1,group=condition,shape=simul),size=2,width=0.1)+
...
p_3<-p_2+
  ...
  geom_jitter(data = data_pre,aes(x=condition,y=Q2,group=condition,shape=simul),size=2,width=0.1)+
...
p_3<-p_2+
  ...
  geom_jitter(data = data_pre,aes(x=condition,y=Q3,group=condition,shape=simul),size=2,width=0.1)+
...
##time_diffの推移(キャッチ，ベースで色分け)


plot_time_diff_pre<-ggplot(data = data_pre,aes(x=trial_num,y=diff_sound_contact))+
  theme_classic()+
...
file_name_time_diff=paste(file_pass,data_adapt$ID[1],"plot_time_diff_pre.png",sep="")
ggsave(file = file_name_time_diff, plot = plot_time_diff_pre, dpi = 100, width = 11.69,height = 8.27)
...
p_3<-p_2+
  geom_bar(data=data_pre_sum_bin,aes(x=bin,y=pain_avg,fill=bin),stat='identity',width=0.5,position = position_dodge(0))+
  geom_jitter(data = data_pre,aes(x=bin,y=rating_pain,group=bin,shape=simul),size=2,width = 0.1)+
  geom_errorbar(data=data_pre_sum_bin,aes(x=bin,ymin=pain_avg-pain_sd,ymax=pain_avg+pain_sd,group=bin,width=0.2),position = position_dodge(0))+
  geom_hline(linetype="dashed",yintercept = 30,col="black")
...
p_3<-p_2+
  geom_bar(data=data_pre_sum_bin,aes(x=bin,y=unp_avg,fill=bin),stat='identity',width=0.5,position = position_dodge(0))+
  geom_jitter(data = data_pre,aes(x=bin,y=rating_unp,group=bin,shape=simul),size=2,width = 0.1)+
  geom_errorbar(data=data_pre_sum_bin,aes(x=bin,ymin=unp_avg-unp_sd,ymax=unp_avg+unp_sd,group=bin,width=0.2),position = position_dodge(0))+
  geom_hline(linetype="dashed",yintercept = 30,col="black")
...
p_3<-p_2+
  geom_bar(data=data_pre_sum_bin,aes(x=bin,y=Q1_avg,fill=bin),stat='identity',width=0.5,position = position_dodge(0))+
  geom_jitter(data = data_pre,aes(x=bin,y=Q1,group=bin,shape=simul),size=2,width = 0.1)+
  geom_errorbar(data=data_pre_sum_bin,aes(x=bin,ymin=Q1_avg-Q1_sd,ymax=Q1_avg+Q1_sd,group=bin,width=0.2),position = position_dodge(0))+
  geom_hline(linetype="dashed",yintercept = 30,col="black")
...
p_3<-p_2+
  geom_bar(data=data_pre_sum_bin,aes(x=bin,y=Q2_avg,fill=bin),stat='identity',width=0.5,position = position_dodge(0))+
  geom_jitter(data = data_pre,aes(x=bin,y=Q2,group=bin,shape=simul),size=2,width = 0.1)+
  geom_errorbar(data=data_pre_sum_bin,aes(x=bin,ymin=Q2_avg-Q2_sd,ymax=Q2_avg+Q2_sd,group=bin,width=0.2),position = position_dodge(0))+
  geom_hline(linetype="dashed",yintercept = 30,col="black")
...
p_3<-p_2+
  geom_bar(data=data_pre_sum_bin,aes(x=bin,y=Q3_avg,fill=bin),stat='identity',width=0.5,position = position_dodge(0))+
  geom_jitter(data = data_pre,aes(x=bin,y=Q3,group=bin,shape=simul),size=2,width = 0.1)+
  geom_errorbar(data=data_pre_sum_bin,aes(x=bin,ymin=Q3_avg-Q3_sd,ymax=Q3_avg+Q3_sd,group=bin,width=0.2),position = position_dodge(0))+
  geom_hline(linetype="dashed",yintercept = 30,col="black")
...
file_pass=paste("result/",data_adapt$ID[1],"/",sep="")
file_name_pain=paste(file_pass,data_adapt$ID[1],"plot_pain_pre_bin.png",sep="")

ggsave(file = file_name_pain, plot = p_pain_bin, dpi = 100, width = 8.27,height = 11.69)


file_name_unp=paste(file_pass,data_adapt$ID[1],"plot_unp_pre_bin.png",sep="")
ggsave(file = file_name_unp, plot = p_unp_bin, dpi = 100, width = 8.27,height = 11.69)


file_name_Q1=paste(file_pass,data_adapt$ID[1],"plot_Q1_pre_bin.png",sep="")
ggsave(file = file_name_Q1, plot = p_Q1_bin, dpi = 100, width = 8.27,height = 11.69)



file_name_Q2=paste(file_pass,data_adapt$ID[1],"plot_Q2_pre_bin.png",sep="")
ggsave(file = file_name_Q2, plot = p_Q2_bin, dpi = 100, width = 8.27,height = 11.69)


file_name_Q3=paste(file_pass,data_adapt$ID[1],"plot_Q3_pre_bin.png",sep="")
